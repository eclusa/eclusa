...
Template for spawning eclusa-debugger agent. The agent contains all debugging expertise - this template provides problem context only.
...
```python
Task(prompt=template, subagent_type="eclusa-debugger", description="Debug UAT-001")
```
...
<prior_state>
Debug file: @.eclusa/debug/{slug}.md
</prior_state>
