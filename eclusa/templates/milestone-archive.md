...
This template is used by the complete-milestone workflow to create archive files in `.eclusa/milestones/`.
...
_For current project status, see .eclusa/ROADMAP.md_
...
- Save to `.eclusa/milestones/v{VERSION}-{NAME}.md`
- Example: `.eclusa/milestones/v1.0-mvp.md`
