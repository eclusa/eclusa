...
Template for `.eclusa/debug/[slug].md` — active debug session tracking.
...
**Creation:** Immediately when /eclusa:debug is called
...
**On resolution:**
- status → "resolved"
- Move file to .eclusa/debug/resolved/ (only after user confirms fix)
