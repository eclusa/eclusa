...
Template for `.eclusa/phases/XX-name/{phase_num}-UAT.md` — persistent UAT session tracking.
...
- This section feeds directly into /eclusa:plan-phase --gaps
...
5. status → "diagnosed"
6. Ready for /eclusa:plan-phase --gaps with root causes
...
**Creation:** When /eclusa:verify-work starts new session
...
- `/eclusa:verify-work {phase}` picks up from first pending/blocked test
