...
Template for `.eclusa/phases/XX-name/DISCOVERY.md` - shallow research for library/option decisions.

**Purpose:** Answer "which library/option should we use" questions during mandatory discovery in plan-phase.

For deep ecosystem research ("how do experts build this"), use `/eclusa:research-phase` which produces RESEARCH.md.
...
<output_structure>
Create `.eclusa/phases/XX-name/DISCOVERY.md`:
...
- Use `/eclusa:research-phase` for these
</guidelines>
