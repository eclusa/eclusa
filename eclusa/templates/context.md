...
Template for `.eclusa/phases/XX-name/{phase_num}-CONTEXT.md` - captures implementation decisions for a phase.
...
- `eclusa-phase-researcher` — Reads decisions to focus research (e.g., "card layout" → research card component patterns)
- `eclusa-planner` — Reads decisions to create specific tasks (e.g., "infinite scroll" → task includes virtualization)
...
**After creation:**
- File lives in phase directory: `.eclusa/phases/XX-name/{phase_num}-CONTEXT.md`
- `eclusa-phase-researcher` uses decisions to focus investigation AND reads canonical_refs to know WHAT docs to study
- `eclusa-planner` uses decisions + research to create executable tasks AND reads canonical_refs to verify alignment
