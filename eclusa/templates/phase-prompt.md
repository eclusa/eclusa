...
> **Note:** Planning methodology is in `agents/eclusa-planner.md`.
> This template defines the PLAN.md output format that the agent produces.

Template for `.eclusa/phases/XX-name/{phase}-{plan}-PLAN.md` - executable phase plans optimized for parallel execution.
...
<!-- For checkpoint task examples and patterns, see @~/.claude/eclusa/references/checkpoints.md -->
...
**Wave is pre-computed:** Wave numbers are assigned during `/eclusa:plan-phase`. Execute-phase reads `wave` directly from frontmatter and groups plans by wave number. No runtime dependency analysis needed.
...
```markdown
<context>
@.eclusa/phases/03-features/03-01-SUMMARY.md  # Just because it's earlier
@.eclusa/phases/03-features/03-02-SUMMARY.md  # Reflexive chaining
</context>
```
...
See `~/.claude/eclusa/references/tdd.md` for TDD plan structure.
...
<output>
After completion, create `.eclusa/phases/03-features/03-01-SUMMARY.md`
</output>
```
...
@.eclusa/PROJECT.md
@.eclusa/ROADMAP.md
@.eclusa/phases/03-features/03-01-SUMMARY.md
@.eclusa/phases/03-features/03-02-SUMMARY.md
</context>
...
<output>
After completion, create `.eclusa/phases/03-features/03-03-SUMMARY.md`
</output>
```
...
See `~/.claude/eclusa/templates/user-setup.md` for full schema and examples
...
See `~/.claude/eclusa/workflows/verify-phase.md` for verification logic.
