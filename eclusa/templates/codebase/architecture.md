...
Template for `.eclusa/codebase/ARCHITECTURE.md` - captures conceptual code organization.
...
1. User runs: `eclusa new-project`
...
**State Management:**
- File-based: All state lives in `.eclusa/` directory
...
- Triggers: User runs `eclusa <command>`
