...
Template for `.eclusa/codebase/STRUCTURE.md` - captures physical file organization.
...
│   └── eclusa/           # Eclusa-specific commands
├── eclusa/     # Skill resources
...
**eclusa/templates/**
- Purpose: Document templates for .eclusa/ files
...
**New Slash Command:**
- Primary code: `commands/eclusa/{command-name}.md`
- Tests: `tests/commands/{command-name}.test.js` (if testing implemented)
- Documentation: Update `README.md` with new command

**New Template:**
- Implementation: `eclusa/templates/{name}.md`
- Documentation: Template is self-documenting (includes guidelines)

**New Workflow:**
- Implementation: `eclusa/workflows/{name}.md`
- Usage: Reference from command with `@~/.claude/eclusa/workflows/{name}.md`

**New Reference Document:**
- Implementation: `eclusa/references/{name}.md`
