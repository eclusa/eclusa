<purpose>
Generate a UI design contract (UI-SPEC.md) for frontend phases. Orchestrates eclusa-ui-researcher and eclusa-ui-checker with a revision loop. Inserts between discuss-phase and plan-phase in the lifecycle.
...
AGENT_SKILLS_UI=$(node "$HOME/.claude/eclusa/bin/eclusa-tools.cjs" agent-skills eclusa-ui-researcher 2>/dev/null)
AGENT_SKILLS_UI_CHECKER=$(node "$HOME/.claude/eclusa/bin/eclusa-tools.cjs" agent-skills eclusa-ui-checker 2>/dev/null)
```
...
```bash
UI_RESEARCHER_MODEL=$(node "$HOME/.claude/eclusa/bin/eclusa-tools.cjs" resolve-model eclusa-ui-researcher --raw)
UI_CHECKER_MODEL=$(node "$HOME/.claude/eclusa/bin/eclusa-tools.cjs" resolve-model eclusa-ui-checker --raw)
```

Check config:

```bash
UI_ENABLED=$(node "$HOME/.claude/eclusa/bin/eclusa-tools.cjs" config-get workflow.ui_phase 2>/dev/null || echo "true")
```

**If `UI_ENABLED` is `false`:**
```
UI phase is disabled in config. Enable via /eclusa:settings.
```
Exit workflow.
...
Recommended: run /eclusa:discuss-phase {N} first to capture design preferences.
...
## 5. Spawn eclusa-ui-researcher

Display:
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 Eclusa ► UI DESIGN CONTRACT — PHASE {N}
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
```markdown
Read ~/.claude/agents/eclusa-ui-researcher.md for instructions.
...
Template: ~/.claude/eclusa/templates/UI-SPEC.md
</output>
...
Task(
  ...
  subagent_type="eclusa-ui-researcher",
...
## 7. Spawn eclusa-ui-checker

Display:
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 Eclusa ► VERIFYING UI-SPEC
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
```markdown
Read ~/.claude/agents/eclusa-ui-checker.md for instructions.
...
Task(
  ...
  subagent_type="eclusa-ui-checker",
...
- Re-spawn eclusa-ui-researcher with revision context:
...
2. Edit manually — open UI-SPEC.md in editor, re-run /eclusa:ui-phase
...
```bash
node "$HOME/.claude/eclusa/bin/eclusa-tools.cjs" commit "docs(${padded_phase}): UI design contract" --files "${PHASE_DIR}/${PADDED_PHASE}-UI-SPEC.md"
```
...
- [ ] eclusa-ui-researcher spawned with correct context and file paths
- [ ] UI-SPEC.md created in correct location
- [ ] eclusa-ui-checker spawned with UI-SPEC.md
