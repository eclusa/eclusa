...
Users currently hand-craft `/eclusa:quick` prompts for test generation after each phase. This workflow standardizes the process with proper classification, quality gates, and gap reporting.
</purpose>
...
Example: `/eclusa:add-tests 12 focus on edge cases` → `$PHASE_ARG=12`, `$EXTRA_INSTRUCTIONS="focus on edge cases"`

If no phase argument provided:

```
ERROR: Phase number required
Usage: /eclusa:add-tests <phase> [additional instructions]
Example: /eclusa:add-tests 12
Example: /eclusa:add-tests 12 focus on edge cases in the pricing module
```
...
Ensure the phase exists in .eclusa/phases/
```
Exit.
...
This command works on completed phases. Run /eclusa:execute-phase first.
```
Exit.
...
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 Eclusa ► ADD TESTS — Phase ${phase_number}: ${phase_name}
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
```
</step>
...
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 Eclusa ► TEST GENERATION COMPLETE
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
```bash
node "$HOME/.claude/eclusa/bin/eclusa-tools.cjs" state-snapshot
```
...
{if bugs discovered:}
**Fix discovered bugs:** `/eclusa:quick fix the {N} test failures discovered in phase ${phase_number}`
...
**Also available:**
- `/eclusa:add-tests {next_phase}` — test another phase
- `/eclusa:verify-work {phase_number}` — run UAT verification
