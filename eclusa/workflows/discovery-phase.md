...
NOTE: For comprehensive ecosystem research ("how do experts build this"), use /eclusa:research-phase instead, which produces RESEARCH.md.
</purpose>
...
See ~/.claude/eclusa/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using ~/.claude/eclusa/templates/discovery.md structure:
...
**Output:** `.eclusa/phases/XX-name/DISCOVERY.md`
</step>
...
1. **Scope the discovery** using ~/.claude/eclusa/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from ~/.claude/eclusa/templates/discovery.md
...
**Output:** `.eclusa/phases/XX-name/DISCOVERY.md` (comprehensive)
</step>
...
Use ~/.claude/eclusa/templates/discovery.md.
...
Write `.eclusa/phases/XX-name/DISCOVERY.md`:
- Summary with recommendation
...
```
Discovery complete: .eclusa/phases/XX-name/DISCOVERY.md
Recommendation: [one-liner]
Confidence: [level]

What's next?

1. Discuss phase context (/eclusa:discuss-phase [current-phase])
2. Create phase plan (/eclusa:plan-phase [current-phase])
