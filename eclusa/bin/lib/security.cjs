 ...
 *
 * This module centralizes security checks for Eclusa tooling. Because Eclusa generates
...
const INJECTION_PATTERNS = [
  ...
  // Note: <instructions> is excluded — Eclusa uses it as legitimate prompt structure
