...
// Eclusa Prompt Injection Guard — PreToolUse hook
// Scans file content being written to .eclusa/ for prompt injection patterns.
// Defense-in-depth: catches injected instructions before they enter agent context.
//
// Triggers on: Write and Edit tool calls targeting .eclusa/ files
...
process.stdin.on('end', () => {
  ...
  try {
    ...
    // Only scan files going into .eclusa/ (agent context files)
