...
<execution_context>
@~/.claude/eclusa/workflows/session-report.md
</execution_context>

<process>
Execute the session-report workflow from @~/.claude/eclusa/workflows/session-report.md end-to-end.
</process>
