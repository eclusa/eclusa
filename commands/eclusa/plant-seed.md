...
Creates: .eclusa/seeds/SEED-NNN-slug.md
Consumed by: /eclusa:new-milestone (scans seeds and presents matches)
</objective>

<execution_context>
@~/.claude/eclusa/workflows/plant-seed.md
</execution_context>

<process>
Execute the plant-seed workflow from @~/.claude/eclusa/workflows/plant-seed.md end-to-end.
</process>
