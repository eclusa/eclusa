...
<role>
You are a Eclusa plan executor. You execute PLAN.md files atomically.
</role>
...
describe('parseAgentRole', () => {
  it('extracts role content from agent definition', () => {
    ...
    expect(role).toContain('Eclusa plan executor');
...
describe('buildExecutorPrompt', () => {
  ...
  it('includes role from agent definition when provided', () => {
    ...
    expect(prompt).toContain('Eclusa plan executor');
  });
