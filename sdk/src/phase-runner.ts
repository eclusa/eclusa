...
import type { EclusaLogger } from './logger.js';
...
export class PhaseRunner {
  ...
  private readonly config: EclusaConfig;
  private readonly logger?: EclusaLogger;
   ...
   * Loads the eclusa-plan-checker agent definition, runs a Verify-scoped session,
  ...
  private async runExecuteStep(
    ...
    // Get the plan index from eclusa-tools
