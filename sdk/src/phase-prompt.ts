...
export class PromptFactory {
  ...
  constructor(options?: {
    eclusaInstallDir?: string;
    agentsDir?: string;
    projectAgentsDir?: string;
    sdkPromptsDir?: string;
  }) {
    const eclusaInstallDir = options?.eclusaInstallDir ?? join(homedir(), '.claude', 'eclusa');
    this.workflowsDir = join(eclusaInstallDir, 'workflows');
   ...
   * falls back to Eclusa-1 originals in workflowsDir.
