...
/**
 * Extract the tools list from a eclusa-executor.md agent definition.
...
/**
 * Extract the role instructions from a eclusa-executor.md agent definition.
 ...
 * @param agentDef - Raw content of eclusa-executor.md agent definition (optional)
