/**
 * WebSocket Transport — broadcasts Eclusa events as JSON over WebSocket.
 *
...
import type { EclusaEvent, TransportHandler } from './types.js';
...
export class WSTransport implements TransportHandler {
  ...
  /**
   * Broadcast a Eclusa event as JSON to all connected clients.
