...
describe('PHASE_AGENT_MAP', () => {
  ...
  it('execute maps to eclusa-executor.md', () => {
    expect(PHASE_AGENT_MAP[PhaseType.Execute]).toBe('eclusa-executor.md');
  });

  it('research maps to eclusa-phase-researcher.md', () => {
    expect(PHASE_AGENT_MAP[PhaseType.Research]).toBe('eclusa-phase-researcher.md');
  });

  it('plan maps to eclusa-planner.md', () => {
    expect(PHASE_AGENT_MAP[PhaseType.Plan]).toBe('eclusa-planner.md');
  });

  it('verify maps to eclusa-verifier.md', () => {
    expect(PHASE_AGENT_MAP[PhaseType.Verify]).toBe('eclusa-verifier.md');
  });
