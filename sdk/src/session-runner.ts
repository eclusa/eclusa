...
import type { ParsedPlan, PlanResult, SessionOptions, SessionUsage, EclusaCostUpdateEvent, PhaseStepType } from './types.js';
import { EclusaEventType, PhaseType } from './types.js';
...
import type { EclusaEventStream, EventStreamContext } from './event-stream.js';
 ...
 */
function resolveModel(options?: SessionOptions, config?: EclusaConfig): string | undefined {
 ...
 * @param config - Eclusa project configuration
