...
const { scanForInjection, INJECTION_PATTERNS } = require('../eclusa/bin/lib/security.cjs');
...
const ALLOWLIST = new Set([
  'eclusa/bin/lib/security.cjs',        // The security module itself
  'hooks/eclusa-prompt-guard.js',                  // The prompt guard hook
