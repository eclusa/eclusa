...
const WORKFLOW_PATH = path.join(__dirname, '..', 'eclusa', 'workflows', 'autonomous.md');
...
describe('autonomous workflow ui-phase and ui-review integration (#1375)', () => {
  ...
  describe('step 3a.5 — UI design contract before planning', () => {
    ...
    test('UI design contract step invokes eclusa:ui-phase skill', () => {
      assert.ok(
        content.includes('skill="eclusa:ui-phase"'),
        'should invoke eclusa:ui-phase via Skill()'
      );
    });
  ...
  describe('step 3d.5 — UI review after execution', () => {
    ...
    test('UI review step invokes eclusa:ui-review skill', () => {
      assert.ok(
        content.includes('skill="eclusa:ui-review"'),
        'should invoke eclusa:ui-review via Skill()'
      );
    });
