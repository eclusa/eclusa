...
Eclusa（Eclusa）フレームワークの包括的なドキュメントです。Eclusa は、AI コーディングエージェント向けのメタプロンプティング、コンテキストエンジニアリング、仕様駆動開発システムです。
...
| [CLI ツールリファレンス](CLI-TOOLS.md) | コントリビューター、エージェント作成者 | `eclusa-tools.cjs` のプログラマティック API（ワークフローおよびエージェント向け） |
...
- **はじめに:** [README](../README.md) → インストール → `/eclusa:new-project`
- **ワークフロー完全ガイド:** [ユーザーガイド](USER-GUIDE.md)
- **コマンド一覧:** [コマンドリファレンス](COMMANDS.md)
- **Eclusa の設定:** [設定リファレンス](CONFIGURATION.md)
