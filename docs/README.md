# Eclusa Documentation

Comprehensive documentation for the Eclusa (Eclusa) framework — a meta-prompting, context engineering, and spec-driven development system for AI coding agents.
...
| [CLI Tools Reference](CLI-TOOLS.md) | Contributors, agent authors | `eclusa-tools.cjs` programmatic API for workflows and agents |
...
- **Getting started:** [README](../README.md) → install → `/eclusa:new-project`
- **Full workflow walkthrough:** [User Guide](USER-GUIDE.md)
- **All commands at a glance:** [Command Reference](COMMANDS.md)
- **Configuring Eclusa:** [Configuration Reference](CONFIGURATION.md)
