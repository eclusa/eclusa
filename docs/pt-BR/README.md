# Documentação do Eclusa

Documentação abrangente do framework Eclusa (Eclusa) — um sistema de meta-prompting, engenharia de contexto e desenvolvimento orientado por especificações para agentes de IA.
...
| [Ferramentas CLI](CLI-TOOLS.md) | Contribuidores, autores de agentes | API programática `eclusa-tools.cjs` |
...
- **Começar rápido:** [README principal](../../README.pt-BR.md) -> instalação -> `/eclusa:new-project`
