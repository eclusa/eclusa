# Arquitetura do Eclusa

Visão arquitetural do Eclusa (Eclusa) em Português.  
...
- **Artefatos persistentes** em `.eclusa/`
...
1. **Camada de comando**  
   Recebe entrada do usuário (`/eclusa:*`) e roteia fluxo.
