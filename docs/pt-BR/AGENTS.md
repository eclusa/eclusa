# Referência de Agentes do Eclusa

Este documento descreve os papéis dos agentes especializados no ecossistema Eclusa.  
...
O Eclusa usa um **orquestrador leve** para coordenar subagentes especializados por etapa:
